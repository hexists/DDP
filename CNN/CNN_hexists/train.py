...
def preprocess():
    ...
    return x_train, y_train, vocab_preprocessor, x_dev, y_dev
...
def train(x_train, y_train, vocab_processor, x_dev, y_dev):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # Dev summaries
            dev_summary_op = tf.summary.merge([loss_summary, acc_summary, grad_summaries_merged])
            dev_summary_dir = os.path.join(out_dir, 'summaries', 'train')
            dev_summary_writer = tf.summary.FileWriter(dev_summary_dir, sess.graph)

            # Checkpoint directory. Tensorflow assumes this directory already exists so we need to creat it
